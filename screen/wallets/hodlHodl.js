...
const styles = StyleSheet.create({
  ...
  blueTextContainer: {
    backgroundColor: BtcpCurrentTheme.colors.mainColor,
    borderRadius: 20,
    width: 110,
    flex: 1,
    flexDirection: 'row',
  ...
  searchInputContainer: {
    flexDirection: 'row',
    borderColor: BtcpCurrentTheme.colors.inputBackgroundColor,
    borderBottomColor: BtcpCurrentTheme.colors.inputBackgroundColor,
    borderWidth: 1.0,
  ...
  noOffersText: { textAlign: 'center', color: BtcpCurrentTheme.colors.feeText, paddingHorizontal: 16 },
  modalFlatList: { width: '100%' },
  itemSeparator: { height: 0.5, width: '100%', backgroundColor: BtcpCurrentTheme.colors.lightBorder },
  itemNameWrapper: { backgroundColor: BtcpCurrentTheme.colors.elevated, flex: 1, flexDirection: 'row', paddingTop: 20, paddingBottom: 20 },
  itemNameBold: { fontSize: 20, color: BtcpCurrentTheme.colors.foregroundColor, fontWeight: 'bold' },
  itemNameNormal: { fontSize: 20, color: BtcpCurrentTheme.colors.foregroundColor, fontWeight: 'normal' },
  whiteBackground: { backgroundColor: BtcpCurrentTheme.colors.background },
  filterCurrencyText: { fontSize: 16, color: BtcpCurrentTheme.colors.foregroundColor },
  filteCurrencyTextWrapper: { color: BtcpCurrentTheme.colors.foregroundColor, right: 0, position: 'absolute' },
  currencyNativeName: { fontSize: 20, color: BtcpCurrentTheme.colors.foregroundColor },
  currencyWrapper: { paddingLeft: 10, flex: 1, flexDirection: 'row' },
  methodNameText: { fontSize: 16, color: BtcpCurrentTheme.colors.foregroundColor },
  ...
  countryNativeNameBold: { fontSize: 20, color: BtcpCurrentTheme.colors.foregroundColor, fontWeight: 'bold' },
  countryNativeNameNormal: { fontSize: 20, color: BtcpCurrentTheme.colors.foregroundColor, fontWeight: 'normal' },
  ...
  avatarWrapper: { backgroundColor: BtcpCurrentTheme.colors.background, flex: 1, flexDirection: 'row' },
  avatarWrapperWrapper: { backgroundColor: BtcpCurrentTheme.colors.background, paddingTop: 16, paddingBottom: 16 },
  headerWrapper: { backgroundColor: BtcpCurrentTheme.colors.background, marginHorizontal: 20, marginBottom: 8 },
